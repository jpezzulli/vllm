...
def _moe_w2_forward_timed(
    ...
    _desc_build_kernel[(triton.cdiv(pairs, 256),)](
        ...
        # row strides (bytes). H-side: a1 fp8 [H], as1 f32 [H/128], c2 bf16 [H].
        # per-rank intermediate side: c13 bf16 [2I], a2 fp8 [I], as2 f32
        # [I/128]. K13 = H, K2 = I -> identical to the old literals on DS4 TP1
        # (H=4096, I=2048); GLM-5.x gets H=6144, TP shards shrink I.
